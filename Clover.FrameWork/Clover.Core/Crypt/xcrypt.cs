...
namespace Clover.Core.XCrypt
{
	...
	{
        static XCryptEngine engine;

        
        
        
        
        public static XCryptEngine Current()
        {
            if (engine == null)
            {
                engine = new XCryptEngine();
            }
		...
		public XCryptEngine() : this(AlgorithmType.Rijndael)
		{			
		}
		...
		{
			_algorithm = al;
            _key = "f3ufUCWplIJ8nGkFem0aN2H551nM2ipJHMypCM2x4ts=";
		...
		public class SymmetricAlgorithmEngine
		{
			...
			public string Encrypting(string Source, string Key)
			{
				...
				srcData = System.Text.Encoding.UTF8.GetBytes(Source);
			...
			public string Decrypting(string Source, string Key)
			{
				...
				return System.Text.Encoding.UTF8.GetString(decData);

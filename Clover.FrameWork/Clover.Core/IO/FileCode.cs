...
namespace Clover.Core.IO
{
    ...
    public class FileCodeHelper
    {
        ...
        {
            return GetHashCodeFromFile(fileName, FileCodeHashType.MD5);
        }
        ...
        public static string GetSHA1Code(string fileName)
        {
            return GetHashCodeFromFile(fileName, FileCodeHashType.SHA1);
        }
        ...
        public static string GetCRC16Code(string fileName)
        {
            return GetHashCodeFromFile(fileName, FileCodeHashType.CRC16);
        }
        ...
        public static string GetCRC32Code(string fileName)
        {
            return GetHashCodeFromFile(fileName, FileCodeHashType.CRC32);
        }
        ...
        private static string GetCodeByByteArray(byte[] retVal)
        {
            if (retVal == null)
                return string.Empty;
        ...
        public class CRC32Util 
        {
            ...
            public static String GetFileCRC32(String filePath)
            {
                ...
                const int MAX_SIZE = 500 * 1024 * 1024;
        ...
        public class CRC16Util
        {
            ...
            private uint value = 0xffff;

            private static UInt32[] CRC16_TABLE = {
        ...
        0x7bc7, 0x6a4e, 0x58d5, 0x495c, 0x3de3, 0x2c6a, 0x1ef1, 0x0f78
            ...
            public static String GetFileCRC16(String filePath)
            {
                const string FOO = "-";
                if (string.IsNullOrEmpty(filePath))
                {
                ...
                foreach (byte b in bin)
                {
                    crc = ((crc >> 8) & 0x00FFFFFF) ^ CRC16_TABLE[(crc ^ b) & 0xFF];
                }
                crc = crc ^ 0xFFFFFFFF;
                return crc.ToString("X");
            }
